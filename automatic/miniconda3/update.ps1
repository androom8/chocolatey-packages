...
$releases = 'https://repo.anaconda.com/miniconda/'
...
function global:au_GetLatest {
    ...
    $url64 = $download_page.links | Where-Object href -match 'Miniconda3-py312_\d+\.\d+\.\d+\-\d+-Windows-x86_64\.exe$' | ForEach-Object href | Select-Object -First 1
    $version = ([regex]::Match($url64, '(\d+\.\d+\.\d+\-\d+)-Windows-x86_64\.exe$')).Groups[1].Value
